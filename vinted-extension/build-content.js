...
// Ordre de chargement des fichiers (important pour les dépendances)
const filesOrder = [
  'config.js',        // CONFIG et state doivent être en premier
...
console.log(`📄 Files bundled: ${filesOrder.length}`);
